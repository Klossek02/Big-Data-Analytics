...
def train():
    ...
    try:
        ...
        if wiki_time_col:
            ...
            print("   -> Wikipedia data loaded OK.")
    except:
        pass

    # EXECUTE and INSPECT JOIN
    ...
    if base_count > 0:
        print(f"SUCCESS: The system identified overlapping timestamps.")
        print(f"DEBUG: Found {base_count} REAL overlapping records.")
    else:
        print("WARNING: No overlapping records found.")
    ...
    if base_count < target_min_rows and base_count > 0:
        ...
        print(f"INFO: Not enough data for robust ML. Applying jittering (x{multiplication_factor})...")
